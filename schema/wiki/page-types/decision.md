...
**Instigation:** authored tier — user-instigated or user-ratified (`schema/wiki/page-types/registry.md`, Instigator Tiers). Agents draft decision records for choices the user has made or ratified; they do not create them unprompted.
...
- A specification of the resulting system itself (that is a design dossier — `schema/design/dossier.md`).
