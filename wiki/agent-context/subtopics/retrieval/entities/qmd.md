...
Installed (`npx @tobilu/qmd@2.5.3`) and run against this wiki's 133 markdown files in the sandboxed session that authored this page — see [[designs/knowledge-surfacing-design]]'s Implementation section for the full account. Findings:
