...
* [[wiki/llm-wiki/decisions/design-as-directory]] — Adopted the directory form for the design type: design.md as standalone target spec, required phases/phase-1.md + later.md + obligations.md (phases/ a complete scope partition), typed subsidiary pages, directory-path linking, opportunistic conversion of legacy single-file designs.
* [[wiki/llm-wiki/decisions/designs-die-into-decisions]] — Deprecated 2026-07-14: the single-file-era lifecycle doctrine (blueprints collapse into decision pages on shipping), superseded by designs-finalize-not-die once the directory form separated spec from phasing.
* [[wiki/llm-wiki/decisions/designs-finalize-not-die]] — Reversed the design lifecycle: a design describes desired state to measure against; at the end of implementation it becomes finalized and immutable (phase documents retained), superseded by later designs rather than collapsed into decisions.
* [[wiki/llm-wiki/decisions/scoped-subtypes-and-roadmap-type]] — Typed the design directory's subsidiary documents without registry bloat: a scoped-type mechanism (parent-owned design/phase) plus one new top-level roadmap planning type shared by wiki/roadmap.md and a design's later.md/obligations.md; renamed follow-ups.md to obligations.md.
