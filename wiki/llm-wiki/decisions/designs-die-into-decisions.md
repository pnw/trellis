...
First application is this very batch: [[wiki/llm-wiki/designs/trellis-repo-design]] deprecated into [[wiki/llm-wiki/decisions/trellis-repo-bootstrap]], and [[wiki/llm-wiki/designs/wiki-federation-and-inheritance]] slimmed to the live design with its executed phases and alternatives moved to [[wiki/llm-wiki/decisions/adopt-single-goal-federation]].
...
`stable` — adopted 2026-07-12, applied the same day. Supersede if the lifecycle rule in the schema is revised to a different collapse target.
...
- [[wiki/llm-wiki/designs/trellis-repo-design]] — the first design deprecated under it
- [[wiki/llm-wiki/designs/wiki-federation-and-inheritance]] — the first design slimmed under it
