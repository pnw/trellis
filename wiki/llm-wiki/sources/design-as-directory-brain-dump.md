...
- [[wiki/llm-wiki/decisions/design-as-directory]] — the schema decision this dump instigates (authored tier, user-instigated)
- `schema/page-types/design.md` — the normative landing place for the directory form
