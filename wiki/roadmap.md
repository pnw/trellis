...
- **Design as directory (adopted 2026-07-14).** Designs become directories: `design.md` target spec separated from untyped phase documents (`phases/phase-1.md` required, `later.md` grab bag) and non-phased `follow-ups.md` (`schema/page-types/design.md`; [[wiki/llm-wiki/decisions/design-as-directory]]). Expected: specs stay standalone requirements documents; phase scoping stops leaking into them; consumers find scope by standard names. Revisit: at the first design created or converted under the rule — did phase-1/later/follow-ups get used as intended, and was the required phase-1 informative rather than ceremony? Watch for: empty-ceremony `phase-1.md` on protocol-style designs with no implementation surface, and phase files accumulating as stale history instead of being pruned as phases ship.
